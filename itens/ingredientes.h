...
#define PAO_CIMA (Ingrediente) {"Topo de Pao", 0, 2}
#define PAO_BAIXO (Ingrediente) {"Base de Pao", 1, 2}
#define CARNE (Ingrediente) {"Carne", 2, 9.9}
...
#define MAIONESE_TEMPERADA (Ingrediente) {"Maionese", 7, 4}
#define BARBERCUE (Ingrediente) {"Barbercue", 8, 4}
#define CEBOLA (Ingrediente) {"Cebola", 9, 5.2}
